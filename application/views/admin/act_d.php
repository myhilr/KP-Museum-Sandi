<div class="card-body">
    ...
    <h1 class="mt-4 mb-4"><b> SMA/MA</b></h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="<?php echo base_url('dashboard');?>">Dashboard</a></li>
                            <li class="breadcrumb-item active"> SMA/MA</li>
                        </ol>
    <div class="card mb-4 mt-2">
                        <div class="card-body">
                        <a href="<?php echo base_url() ?>dashboard/export_act" class="btn btn-primary" style="float:left;">Export Jadwal</a>
